...
export const mergeDeepLeftAndGetEntity =
    <TEntity extends IEntity>(target: TEntity,
                              source: TEntity): TEntity =>
        mergeDeepLeftAndGetChanges<TEntity>(target, source);
