...
describe('date-converter.service', () => {
  ...
  describe('fromUiDateTimeToDateTime', () => {
    ...
    it('test1', () => {
      const value = dateConverter.fromUiDateTimeToDateTimeString({date: '2036-07-31', time: '22:56:33'});
      expect(value).toEqual('2036-07-31T22:56:33-07:00');
    });
    it('test2', () => {
      const value = dateConverter.fromUiDateTimeToDateTimeString({date: '2036-07-31', time: '22:56', strict: false});
      expect(value).toEqual('2036-07-31T22:56:00-07:00');
    });
    it('test3', () => {
      const value = dateConverter.fromUiDateTimeToDateTimeString({date: '2036-07-31', time: '22', strict: false});
      expect(value).toEqual('2036-07-31T22:00:00-07:00');
    });
    it('test4', () => {
      const value = dateConverter.fromUiDateTimeToDateTimeString({date: '2036-07-31'});
  ...
  describe('fromDateToUiDate', () => {
    // https://www.timeanddate.com/worldclock/converter.html
    it('test1', () => {
      const value = dateConverter.fromDateToUiDateString({date: '2036-07-31'});
      expect(value).toEqual('2036-07-31');
    });
    it('test2', () => {
      const value = dateConverter.fromDateToUiDateString({date: '2036-07-31T00:00:00Z'});
      expect(value).toEqual('2036-07-31');
    });
  });
  ...
  describe('fromDateTimeToUiDate', () => {
    // https://www.timeanddate.com/worldclock/converter.html
    it('test1', () => {
      const value = dateConverter.fromDateTimeToUiDateString({date: '2036-07-31T00:00:00+03:00'});               // Moscow, Russia
      expect(value).toEqual('2036-07-30');                                                                 // Los Angeles, USA
    });
    it('test2', () => {
      const value = dateConverter.fromDateTimeToUiDateString({date: '2036-07-31T05:00:00+03:00'});               // Moscow, Russia
      expect(value).toEqual('2036-07-30');                                                                 // Los Angeles, USA
    });
    it('test3', () => {
      const value = dateConverter.fromDateTimeToUiDateString({date: new Date('2036-07-31T05:00:00+03:00')});     // Moscow, Russia
      expect(value).toEqual('2036-07-30');                                                                 // Los Angeles, USA
    });
  });
  ...
  describe('fromDateTimeToUiDateTime', () => {
    // https://www.timeanddate.com/worldclock/converter.html
    it('test1', () => {
      const value = dateConverter.fromDateTimeToUiDateTimeString({date: '2036-07-31T00:00:00+03:00'});               // Moscow, Russia
      expect(value).toEqual('2036-07-30 14:00:00');                                                            // Los Angeles, USA
    });
    it('test2', () => {
      const value = dateConverter.fromDateTimeToUiDateTimeString({
